...
- (void)swipe:(UISwipeGestureRecognizer *)gesture {
    ...
    BSStackViewItemDirection direction = forward ? BSStackViewItemDirectionBack : BSStackViewItemDirectionFront;
    [self.delegate stackView:self currentItem:[views lastObject] direction:direction];
...
-(void)handleSingleTapOnView:(UITapGestureRecognizer*)gesture{
     [[self delegate]showUserProfileFromScroreBoardWithIndex:gesture.view.tag];
}
