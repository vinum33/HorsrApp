...
- (void)activate{
    ...
    origin = [self.vwBtnSuperView convertPoint:self.frame.origin toView:nil];
    
    origin = [self.superview convertPoint:self.origin toView:self.vwBtnSuperView];
    //NSLog(@"points %f %f", p.x , p.y);
    ...
    [self.vwBtnSuperView addSubview:selectorBgView];
    [_vwBtnSuperView bringSubviewToFront:selectorBgView];
