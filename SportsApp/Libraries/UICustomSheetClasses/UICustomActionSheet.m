...
-(instancetype)initWithTitle:(NSString *)caption delegate:(id<UICustomActionSheetDelegate>)delegate buttonTitles:(NSArray *)titles {
    ...
    if (self = [super init]) {
        ...
        _buttonsTextColor = [UIColor getBlackTextColor];
...
-(void)showInView:(UIView *)view{
    ...
    backgroundImage.backgroundColor = [UIColor colorWithRed:0/255.f green:0/255.f blue:0/255.f alpha:0.8];
    ...
    for (NSString *buttonTitle in buttonTitles) {
        ...
        button.titleLabel.font = [UIFont fontWithName:CommonFont size:14];
        [button.layer setCornerRadius:3.0];
        
        if (index == 1) {
            [button setImage:[UIImage imageNamed:@"Share_Post"] forState:UIControlStateNormal];
        }
        if (index == 2) {
            [button setImageEdgeInsets:UIEdgeInsetsMake(0, -35, 0, 0)];
            [button setTitleEdgeInsets:UIEdgeInsetsMake(0, -30, 0, 0)];
            [button setImage:[UIImage imageNamed:@"Write_Post"] forState:UIControlStateNormal];
        }
        index ++;
    ...
    if ([buttonTitles count] > 0) {
        ...
        if (_subtitle) {
            ...
            subtitle.font = [UIFont fontWithName:CommonFont size:13];
        ...
        if (_title) {
            ...
            mainTitle.font = [UIFont fontWithName:CommonFont size:15];
